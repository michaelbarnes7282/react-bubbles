...
certifies user identity to allow access to a site and its data

- [ ] What steps can you take in your web apps to keep your data secure?

implement token verification, protectedroutes

- [ ] Describe how web servers work.

they contain the code for different website to be used around the world.
